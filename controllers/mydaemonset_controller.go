...
import (
	...
	appsv1beta1 "github/xincuni/gqapwd/api/v1beta1"
)
...
//+kubebuilder:rbac:groups=apps.gqapwd.com,resources=mydaemonsets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=apps.gqapwd.com,resources=mydaemonsets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=apps.gqapwd.com,resources=mydaemonsets/finalizers,verbs=update

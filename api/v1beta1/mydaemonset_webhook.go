...
//+kubebuilder:webhook:path=/mutate-apps-gqapwd-com-v1beta1-mydaemonset,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.gqapwd.com,resources=mydaemonsets,verbs=create;update,versions=v1beta1,name=mmydaemonset.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-apps-gqapwd-com-v1beta1-mydaemonset,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.gqapwd.com,resources=mydaemonsets,verbs=create;update,versions=v1beta1,name=vmydaemonset.kb.io,admissionReviewVersions=v1
